import {classMap, property, query, state} from "./chunk-O5E36MZD.js";
import "./chunk-JYAXTGHO.js";
import {css, html, LitElement, nothing} from "./chunk-3EHXIY74.js";
...
var checkLicenseIfNeeded = (cvdlElement) => {
  var _a;
...
var licenseCheckNoKey = (data) => {
  ...
  const productName = data.product.name;
  data.messageHtml = `No license found. <a target=_blank onclick="window.open(this.href);return false;" href="${keyUrl}">Go here to start a trial or retrieve your license.</a>`;
  productMissingLicense[key(data.product)] = data;
...
//# sourceMappingURL=@vaadin_flow-frontend_vaadin-dev-tools__js.js.map
