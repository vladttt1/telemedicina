import {
  Grid,
  ItemCache
} from "./chunk-ZRAAVYWR.js";
import "./chunk-WCPVLQ3S.js";
import {
  isFocusable
} from "./chunk-WRZI7T35.js";
import "./chunk-VSCZH33X.js";
    ...
    initLazy: (grid) => tryCatchWrapper(function(grid2) {
      ...
      grid2.$connector.set = tryCatchWrapper(function(index, items, parentKey) {
        ...
        for (let i = 0; i < updatedPageCount; i++) {
          ...
          grid2.$connector.doSelection(slice.filter((item) => item.selected));
