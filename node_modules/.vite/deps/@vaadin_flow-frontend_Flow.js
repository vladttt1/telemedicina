import {ConnectionIndicator, ConnectionState} from "./chunk-FMHHIRO2.js";
import "./chunk-O5E36MZD.js";
...
var Flow = class {
  ...
  async flowInit(serverSideRouting = false) {
    if (!this.isFlowClientLoaded()) {
      ...
      const bootstrapMod = await import("./FlowBootstrap-JKZEG2DC.js");
      await bootstrapMod.init(this.response);
      if (typeof this.config.imports === "function") {
        this.injectAppIdScript(appId);
        await this.config.imports();
      }
      const clientMod = await import("./FlowClient-6BFCOSNB.js");
